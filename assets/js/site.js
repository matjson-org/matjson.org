(() => {
  ...
  const pages = [
    ...
    { title: 'MatRecordJSON', description: 'Normalized MTR, CMTR, certificate, test, process, and evidence records. Working draft v0.1.', href: ROOT + 'profiles/matrecord/index.html' },
    { title: 'MatCheckJSON', description: 'Auditable material compliance outcomes. Working draft v0.1.', href: ROOT + 'profiles/matcheck/index.html' },
    { title: 'MatJSON Core', description: 'Shared semantic primitives and vocabularies. Working draft v0.1.', href: ROOT + 'profiles/core/index.html' },
